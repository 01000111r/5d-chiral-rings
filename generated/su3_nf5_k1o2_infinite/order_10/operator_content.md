# Operator content: `su3_nf5_k1o2_infinite`

## 1. Verified series data

The first negative refined-PL degree is **4**. Exact reconstruction checks are an input prerequisite.
